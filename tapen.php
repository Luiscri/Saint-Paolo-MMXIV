...
<html lang="en">
  <head>
      ...
      ?>
      <link rel="canonical" href="https://saintpaolommxiv.es/tapen">
  </head>
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-12 resize">
                        <a class="mr-1 noDecoration" href="tienda.php">Tienda</a> > <a class="mx-1 noDecoration" href="tienda.php">Sudaderas</a> > <span class="ml-1">Sudadera Tape Azul Marino</span>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-4 centerBoth">
                        <div class="zoom">
                            <div id="img1" class="mb-2">
                                <img src="images/sudaderas/mangasb.jpeg" id="mainImg" width="300" height="400" alt="Sudadera Cinta Verde"/>
                            </div>
                            <div class="text-center">
                                <img src="images/sudaderas/mangasb.jpeg" class="thumbnail mr-1" id="thumbnail-1" width="120" height="160">
                                <img src="images/sudaderas/mangasb2.jpg" class="thumbnail" id="thumbnail-2" width="120" height="160">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-8 centerVertical mt-4">
                        <div class="text-center">
                            <p class="fontBig">Sudadera Tape Azul Marino - 35€</p>
                        </div>
                        ...
                        <div id="accordion" class="mt-3">
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        <p>Sudadera con una cinta que recorre todo el lateral de las mangas desde el nacimiento del cuello hasta el puño. </p>
                                        <ul>
                        ...
                        <!-- Buy Button -->
                        <div id="product-component-bb60653c92e" class="centerHorizontal mt-5"></div>
                    </div>
                </div>
            </div> <!-- .container -->
        </section>
    ...
    <script type="text/javascript">
        $(function(){
            $("#thumbnail-1").on('click', function(){
                changeImage("images/sudaderas/mangasb.jpeg");
            });

            $("#thumbnail-2").on('click', function(){
                changeImage("images/sudaderas/mangasb2.jpg");
            });
            ...
            function ShopifyBuyInit() {
                ...
                ShopifyBuy.UI.onReady(client).then(function (ui) {
                    ui.createComponent('product', {
                        id: [651228774463],
                        node: document.getElementById('product-component-bb60653c92e'),
