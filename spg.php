...
<html lang="en">
  <head>
      ...
      ?>
      <link rel="canonical" href="https://saintpaolommxiv.es/spg">
  </head>
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-12 resize">
                        <a class="mr-1 noDecoration" href="tienda.php">Tienda</a> > <a class="mx-1 noDecoration" href="tienda.php">Sudaderas</a> > <span class="ml-1">Sudadera España Gris</span>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-4 centerBoth">
                        <div class="zoom">
                            <div id="img1" class="mb-2">
                                <img src="images/sudaderas/spg.jpeg" id="mainImg" width="300" height="400" alt="Sudadera Gris España"/>
                            </div>
                            <div class="text-center">
                                <img src="images/sudaderas/spg.jpeg" class="thumbnail mr-1" id="thumbnail-1" width="120" height="160">
                                <img src="images/sudaderas/spg2.jpeg" class="thumbnail" id="thumbnail-2" width="120" height="160">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-8 centerVertical mt-4">
                        <div class="text-center">
                            <p class="fontBig">Sudadera España Gris - 35€</p>
                        </div>
                        ...
                        <!-- Buy Button -->
                        <div id="product-component-9aba25c5653" class="centerHorizontal mt-5"></div>
                    </div>
                </div>
            </div> <!-- .container -->
        </section>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#thumbnail-1").on('click', function(){
                changeImage("images/sudaderas/spg.jpeg");
            });

            $("#thumbnail-2").on('click', function(){
                changeImage("images/sudaderas/spg2.jpeg");
            });
