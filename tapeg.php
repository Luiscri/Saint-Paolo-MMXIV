...
<html lang="en">
  <head>
      ...
      ?>
      <link rel="canonical" href="https://saintpaolommxiv.es/tapeg">
  </head>
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-12 resize">
                        <a class="mr-1 noDecoration" href="tienda.php">Tienda</a> > <a class="mx-1 noDecoration" href="tienda.php">Sudaderas</a> > <span class="ml-1">Sudadera Tape Verde</span>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-4 centerBoth">
                        <div class="zoom">
                            <div id="img1" class="mb-2">
                                <img src="images/sudaderas/mangasg.jpeg" id="mainImg" width="300" height="400" alt="Sudadera Cinta Verde"/>
                            </div>
                            <div class="text-center">
                                <img src="images/sudaderas/mangasg.jpeg" class="thumbnail mr-1" id="thumbnail-1" width="120" height="160">
                                <img src="images/sudaderas/mangasg2.jpg" class="thumbnail" id="thumbnail-2" width="120" height="160">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-8 centerVertical mt-4">
                        <div class="text-center">
                            <p class="fontBig">Sudadera Tape Verde - 35€</p>
                        </div>
                        ...
                        <!-- Buy Button -->
                        <div id="product-component-6be0282f3ee" class="centerHorizontal mt-5"></div>
                    </div>
                </div>
            </div> <!-- .container -->
        </section>
    ...
    <script type="text/javascript">
        $(function(){
            $("#thumbnail-1").on('click', function(){
                changeImage("images/sudaderas/mangasg.jpeg");
            });

            $("#thumbnail-2").on('click', function(){
                changeImage("images/sudaderas/mangasg2.jpg");
            });
            ...
            function ShopifyBuyInit() {
                ...
                ShopifyBuy.UI.onReady(client).then(function (ui) {
                    ui.createComponent('product', {
                        id: [651228020799],
                        node: document.getElementById('product-component-6be0282f3ee'),
