...
<html lang="en">
  <head>
      ...
      ?>
      <link rel="canonical" href="https://saintpaolommxiv.es/zipg">
  </head>
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-12 resize">
                        <a class="mr-1 noDecoration" href="tienda.php">Tienda</a> > <a class="mx-1 noDecoration" href="tienda.php">Sudaderas</a> > <span class="ml-1">Sudadera Zip Verde</span>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-4 centerBoth">
                        <div class="zoom">
                            <div id="img1" class="mb-2">
                                <img src="images/sudaderas/zipg.jpg" id="mainImg" width="300" height="400" alt="Sudadera Zip Verde"/>
                            </div>
                            <div class="text-center">
                                <img src="images/sudaderas/zipg.jpg" class="thumbnail mr-1" id="thumbnail-1" width="120" height="160">
                                <img src="images/sudaderas/zipg2.jpg" class="thumbnail" id="thumbnail-2" width="120" height="160">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-8 centerVertical mt-4">
                        <div class="text-center">
                            <p class="fontBig">Sudadera Zip Verde - 35€</p>
                        </div>
                        ...
                        <div id="accordion" class="mt-3">
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        <p>Sudadera con cremallera a medio cuerpo y bordado de nuestro logotipo en el lado izquierdo del pecho.</p>
                                        <ul>
                        ...
                        <!-- Buy Button -->
                        <div id="product-component-71db912d7ad" class="centerHorizontal mt-5"></div>
                    </div>
                </div>
            </div> <!-- .container -->
        </section>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#thumbnail-1").on('click', function(){
                changeImage("images/sudaderas/zipg.jpg");
            });

            $("#thumbnail-2").on('click', function(){
                changeImage("images/sudaderas/zipg2.jpg");
            });
            ...
            function ShopifyBuyInit() {
                ...
                ShopifyBuy.UI.onReady(client).then(function (ui) {
                    ui.createComponent('product', {
                        id: [657373265983],
                        node: document.getElementById('product-component-71db912d7ad'),
