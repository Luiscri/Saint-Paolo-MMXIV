...
<html lang="en">
  <head>
      ...
      ?>
      <link rel="canonical" href="https://saintpaolommxiv.es/zipn">
  </head>
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-12 resize">
                        <a class="mr-1 noDecoration" href="tienda.php">Tienda</a> > <a class="mx-1 noDecoration" href="tienda.php">Sudaderas</a> > <span class="ml-1">Sudadera Zip Azul Marino</span>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-4 centerBoth">
                        <div class="zoom">
                            <div id="img1" class="mb-2">
                                <img src="images/sudaderas/zipn.jpg" id="mainImg" width="300" height="400" alt="Sudadera Gris España"/>
                            </div>
                            <div class="text-center">
                                <img src="images/sudaderas/zipn.jpg" class="thumbnail mr-1" id="thumbnail-1" width="120" height="160">
                                <img src="images/sudaderas/zipn2.jpg" class="thumbnail" id="thumbnail-2" width="120" height="160">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-8 centerVertical mt-4">
                        <div class="text-center">
                            <p class="fontBig">Sudadera Zip Azul Marino - 35€</p>
                        </div>
                        ...
                        <div id="accordion" class="mt-3">
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        <p>Sudadera con cremallera a medio cuerpo y bordado de "Saint Paolo" en el lado izquierdo del pecho con una fuente diseñada especialmente para este diseño.</p>
                                        <ul>
                                            <li>80% algodón - 20% poliéster</li>
                                            <li>Cremallera metálica con revestimiento</li>
                                            <li>Cuello semi-cisne con tapeta de punto simple</li>
                                            <li>Corte moderno ajustado</li>
                                            <li>Bajo y puños en canalé de algodón</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Buy Button -->
                        <div id="product-component-a8fbc414e27" class="centerHorizontal mt-5"></div>
                    </div>
                </div>
            </div> <!-- .container -->
        </section>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#thumbnail-1").on('click', function(){
                changeImage("images/sudaderas/zipn.jpg");
            });

            $("#thumbnail-2").on('click', function(){
                changeImage("images/sudaderas/zipn2.jpg");
            });
            ...
            function ShopifyBuyInit() {
                ...
                ShopifyBuy.UI.onReady(client).then(function (ui) {
                    ui.createComponent('product', {
                        id: [657399971903],
                        node: document.getElementById('product-component-a8fbc414e27'),
